...
class TestWgInterface(unittest.TestCase):
    ...
    @patch("interface.executor.WgExecutor._run")
    def test_invalid_data_fails_validation(self, wg_executor_run):
        cases = [
            (
                {
                    "name": "",
        ...
        wg_executor_run.side_effect = self.wg_executor_run_side_effect
